  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-heading font-bold text-white">Portfolio Management</h2>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-white/5 text-gray-400">
              ...
              <th className="text-left p-4 font-medium hidden md:table-cell">Client</th>
          ...
          <tbody>
            {portfolioItems.map((item) => (
              <tr key={item.id} className="border-b border-white/5 hover:bg-white/5">
                ...
                <td className="p-4 text-gray-400 hidden md:table-cell">{item.category}</td>
                <td className="p-4 text-gray-400 hidden md:table-cell">{item.client}</td>
